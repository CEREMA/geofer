...
public interface InstallationTermRepository extends GenericRepository<InstallationTerm, Integer> {
 
  List<InstallationTerm> findByRefActivitePrincipale(RefActivitePrincipale refActivitePrincipale);
