...
public interface PassageNiveauRepository extends GenericRepository<PassageNiveau, Integer> {
 
  List<PassageNiveau> findByRefClassePassageNiveau(RefClassePassageNiveau refClassePassageNiveau);
